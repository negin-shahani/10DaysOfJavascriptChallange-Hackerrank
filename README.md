...
**Task:** _Implement a simple calculator that performs the following operations on binary numbers: addition, subtraction, multiplication, and division. Note that division operation must be integer division only; for example, `1001/100 = 10`, `1110/101 = 10`, and `101/1 = 101`._

_The calculator's initial state must look like this:_ </br> </br>
      <p align="center">
            <img src="https://s3.amazonaws.com/hr-challenge-images/0/1456642859-ad1191f53b-ScreenShot2016-02-28at12.29.21PM.png" alt="TryHackMe">
      </p>
...
-  `Styling`. The document's elements must have the following styles:
    ...
    - `btn0` and `btn1` have a `background-color` of `lightgreen` and a c`olor` of `brown`.
